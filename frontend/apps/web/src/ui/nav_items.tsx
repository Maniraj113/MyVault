...
export const ALL_ITEMS: NavItem[] = [
  { to: '/inbox', label: 'Home', icon: (p) => <Home className={p.className} />, priority: 1 },
  { to: '/chat', label: 'Chat', icon: (p) => <MessageCircle className={p.className} />, priority: 2 },
  { to: '/expenses', label: 'Expenses', icon: (p) => <Wallet className={p.className} />, priority: 3 },
  { to: '/docs', label: 'Documents', icon: (p) => <FileImage className={p.className} />, priority: 4 },
  { to: '/notes', label: 'Notes', icon: (p) => <StickyNote className={p.className} />, priority: 5 },
  ...
  { to: '/links', label: 'Links', icon: (p) => <LinkIcon className={p.className} />, priority: 8 },
];
